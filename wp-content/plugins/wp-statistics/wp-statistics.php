...
*/
	...
	function wp_statistics_networkmenu() {
		...
		$read_cap = wp_statistics_validate_capability( $WP_Statistics->get_option('read_capability', 'edit_pages') );

		$manage_cap = wp_statistics_validate_capability( $WP_Statistics->get_option('manage_capability', 'edit_pages') );
