...
Plugin Name: Fetured Links Sakala
...

{
...

    {
        ...
        $columns = array(
            ...
            'name' => __('Featured Name', 'custom_table_example'),

            'email' => __('Featured Link', 'custom_table_example'),

            'age' => __('New Featured Link', 'custom_table_example'),
...

{
    ...
    add_menu_page(__('Featured Link', 'custom_table_example'), __('Recent Notifications', 'custom_table_example'), 'edit_pages', 'persons', 'custom_table_example_persons_page_handler');

    add_submenu_page('persons', __('Featured Link', 'custom_table_example'), __('Recent Notification', 'custom_table_example'), 'edit_pages', 'persons', 'custom_table_example_persons_page_handler');

    // add new will be described in next part

    add_submenu_page('persons', __('Add new', 'custom_table_example'), __('Add new', 'custom_table_example'), 'edit_pages', 'persons_form', 'custom_table_example_persons_form_page_handler');
...
<div class="wrap">
    ...
    <h2><?php _e('Recent Notification', 'custom_table_example')?> <a class="add-new-h2"
...

{
    ...
    add_meta_box('persons_form_meta_box', 'Feature Data', 'custom_table_example_persons_form_meta_box_handler', 'person', 'normal', 'default');
...
<table cellspacing="2" cellpadding="5" style="width: 100%;" class="form-table">
    ...
    <tr class="form-field">
        ...
        <th valign="top" scope="row">
            ...
            <label for="name"><?php _e('Feature Link Name', 'custom_table_example')?></label>
        ...
        <td>
            ...
            <input id="name" name="name" type="text" style="width: 95%" value="<?php echo esc_attr($item['name'])?>"
                   ...
                   size="50" class="code" placeholder="<?php _e('Feature Link Name', 'custom_table_example')?>" required>
    ...
    <tr class="form-field">
        ...
        <th valign="top" scope="row">
            ...
            <label for="email"><?php _e('Feature Link URL', 'custom_table_example')?></label>
        ...
        <td>
            ...
            <input id="email" name="email" type="text" style="width: 95%" value="<?php echo esc_attr($item['email'])?>"
                   ...
                   size="50" class="code" placeholder="<?php _e('Feature Link URL', 'custom_table_example')?>" required>
    ...
    <tr class="form-field">
        ...
        <th valign="top" scope="row">
            ...
            <label for="age"><?php _e('Feature Link', 'custom_table_example')?></label>

        </th>

        <td>

            <input id="age" name="age" type="checkbox" value="Yes"

                   size="50" class="code"> Yes

                   <input id="age" name="age" type="checkbox" value="No"

                   size="50" class="code" > No
